...
//     db.run("CREATE TABLE configuration (host text NOT NULL, port INTEGER NOT NULL, secure INTEGER NOT NULL, user text NOT NULL, password text NOT NULL, mailFrom text NOT NULL);");
...
//     db.run("INSERT INTO configuration (host, port, secure, user, password, mailFrom) VALUES('smtp.ethereal.email', 587, 0, 'kacper', 'pass', 'kacper@gmail.com');");
...
user.displayMailsFromFile('D:/Documents/Desktop/test.txt');
